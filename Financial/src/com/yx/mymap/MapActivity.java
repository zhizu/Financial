	...
	private LatLng coordinate = null;
	  ...
	  @Override
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        System.out.println("yangxuxuxu--->" + coordinate.latitude + "        " + coordinate.longitude);
	       map = ((SupportMapFragment)  getSupportFragmentManager().findFragmentById(R.id.map))
	                .getMap();
	        
	        map.setMapType(GoogleMap.MAP_TYPE_NORMAL);
	        map.addMarker(new MarkerOptions().position(new LatLng( 35.658412064282, 139.762573242188)).title("Marker"));
			...
			AsyncHttpClient client = new AsyncHttpClient();
			 client.get(MapActivity.this, "http://maps.googleapis.com/maps/api/directions/json?origin=35.6982201,139.7468066&destination=35.658412064282,139.762573242188&sensor=false&mode=walking", new JsonHttpResponseHandler(){
				@Override
